...
| storage | object | `{"bucketName":"my-s3-bucket","custom":{},"enableMultiContainer":false,"gcs":null,"limits":{"maxDownloadMBs":10},"s3":{"accessKey":"","authType":"iam","extraArgs":"","region":"us-east-1","secretKey":""},"type":"sandbox"}` | ----------------------------------------------------  STORAGE SETTINGS  |
...
| storage.s3.extraArgs | string | `""` | Extra arguments, as a JSON object of key/value pairs, passed to S3 upload |
