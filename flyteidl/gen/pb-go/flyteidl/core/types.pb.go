...
type OutputReference struct {
	...
	Var      int32               `protobuf:"varint,2,opt,name=var,proto3" json:"var,omitempty"`
...
func (x *OutputReference) GetVar() int32 {
	if x != nil {
		return x.Var
	}
	return 0
...
var file_flyteidl_core_types_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x76, 0x61, 0x72, 0x12, 0x3c, 0x0a,
