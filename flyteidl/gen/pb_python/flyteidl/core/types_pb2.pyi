...
class OutputReference(_message.Message):
    __slots__ = ["node_id", "variable_name", "attr_path"]
    ...
    def __init__(self, node_id: _Optional[str] = ..., variable_name: _Optional[str] = ..., attr_path: _Optional[_Iterable[_Union[PromiseAttribute, _Mapping]]] = ...) -> None: ...
